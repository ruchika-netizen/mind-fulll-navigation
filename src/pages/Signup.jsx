  ...
  const handleSignup = async (e) => {
    ...
    try {
      ...
      if (error) {
        ...
        // Success: Sirf message dikhao aur form reset karo
        ...
        // Session clear karna zaroori hai taaki automatic login background mein na ho
          ...
          <div className="space-y-2">
            ...
            <div className="relative group">
              ...
              <button
                ...
                className="absolute right-4 top-1/2 -translate-y-1/2 text-[#36454F]/30 hover:text-[#36454F] p-1"
              >
