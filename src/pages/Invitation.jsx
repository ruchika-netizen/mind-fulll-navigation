        ...
        <div className="flex-1 p-8 md:p-8 flex flex-col bg-white min-h-full">
          <div className="flex-grow">
            ...
            <div className="flex flex-col md:flex-row gap-12 items-stretch">
              <div className="flex-1 space-y-4 group">
                ...
                <p className="text-[14px] italic font-sans leading-relaxed  transition-opacity duration-500">
          ...
          <div className="flex justify-end pt-3 ">
            <button
              ...
              className="group flex items-center gap-4 bg-[#36454F] text-[#F5F0E8] pl-7 pr-6 py-3.5 rounded-full text-[10px] uppercase tracking-[0.3em] font-sans font-bold transition-all duration-700 hover:bg-black hover:shadow-xl active:scale-95 shadow-md">
              Continue
